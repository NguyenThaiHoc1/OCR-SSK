...
para_values = {
    'use_gpu': False,
    'image_dir': '/content/aaa.png',
    'rec_algorithm': 'SVTR_LCNet',
    'rec_model_dir': '/content/model/japan/jp_ppocr_v4_model.onnx',
    'rec_image_inverse': True,
    'rec_image_shape': '3,48,-1',
    'rec_batch_num': 6,
    'max_text_length': 25,
    'rec_char_dict_path': '/content/PaddleOCR/rec_onnx/JapaneseOCR.onnx',
    #'rec_char_dict_path': '/content/PaddleOCR/ppocr/utils/dict/japan_dict.txt',
    'use_space_char': True,
    'drop_score': 0.5,
    'benchmark': False,
    'use_onnx': True
